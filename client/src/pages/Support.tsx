...
const SHARE_TEXT =
  'Check out Internet Download Hub — a free desktop app that downloads videos from YouTube, TikTok, Twitter, Instagram and 1000+ other sites. Completely free and open source.';
...
export default function Support() {
  ...
  const paymentByRegion = PAYMENT_OPTIONS.reduce(
    (acc, opt) => {
